...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", ccmchain.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", ccmchain.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", ccmchain.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", ccmchain.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", ccmchain.SyncProgress{
