...
func makeMiner(genesis *core.Genesis) (*node.Node, *protocol.Ethereum, error) {
	...
	ethBackend, err := protocol.New(stack, &protocol.Config{
		Genesis:         genesis,
		...
		GPO:             protocol.DefaultConfig.GPO,
		Ethash:          protocol.DefaultConfig.Ethash,
		Miner: miner.Config{
