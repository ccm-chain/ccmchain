...
func (mc *mockCaller) CallContract(ctx context.Context, call ccmchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call ccmchain.CallMsg) ([]byte, error) {
