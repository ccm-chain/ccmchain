...
func TestGolangBindings(t *testing.T) {
	...
	// Convert the package to go modules and use the current source for ccmchain
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-replace", "github.com/ccm-chain/ccmchain="+filepath.Join(pwd, "..", "..", "..")) // Repo root
	replacer.Dir = pkg
