...
func NewChtIndexer(db database.Database, odr OdrBackend, size, confirms uint64) *core.ChainIndexer {
...
func NewBloomTrieIndexer(db database.Database, odr OdrBackend, parentSize, size uint64) *core.ChainIndexer {
