...
import (
	...
	"github.com/ccm-chain/ccmchain/core/state/snapshot"
...
// Processor.
func NewBlockChain(db database.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config, shouldPreserve func(block *types.Block) bool, txLookupLimit *uint64) (*BlockChain, error) {
	if cacheConfig == nil {
...
func (bc *BlockChain) SetHead(head uint64) error {
	...
	updateFn := func(db database.KeyValueWriter, header *types.Header) (uint64, bool) {
