...
func wipeSnapshot(db database.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db database.KeyValueStore) error {
...
func wipeKeyRange(db database.KeyValueStore, kind string, prefix []byte, keylen int) error {
