...
type Tree struct {
	diskdb database.KeyValueStore   // Persistent database to store the snapshot
...
// background thread.
func New(diskdb database.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
