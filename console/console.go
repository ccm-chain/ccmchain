...
import (
	...
	"github.com/ccm-chain/ccmchain/console/prompt"
	"github.com/ccm-chain/ccmchain/internal/jsre"
	"github.com/ccm-chain/ccmchain/internal/jsre/deps"
	"github.com/ccm-chain/ccmchain/internal/web3ext"
...
func (c *Console) initExtensions() error {
	...
	aliases := map[string]struct{}{"ccm": {}, "personal": {}}
	for api := range apis {
		if api == "web3" {
			continue
		}
...
// Welcome show summary of current Gccm instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gccm JavaScript console!\n\n"

	// Print some generic Gccm metadata
	if res, err := c.jsre.Run(`
		var message = "instance: " + web3.version.node + "\n";
		try {
			message += "coinbase: " + ccm.coinbase + "\n";
		} catch (err) {}
		message += "at block: " + ccm.blockNumber + " (" + new Date(1000 * ccm.getBlock(ccm.blockNumber).timestamp) + ")\n";
		try {
