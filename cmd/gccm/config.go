...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "ccm")
	cfg.WSModules = append(cfg.WSModules, "ccm")
...
func makeConfigNode(ctx *cli.Context) (*node.Node, gethConfig) {
	...
	if file := ctx.GlobalString(configFileFlag.Name); file != "" {
		...
		if cfg.Shh != (whisperDeprecatedConfig{}) {
			log.Warn("Deprecated whisper config detected. Whisper has been moved to github.com/ccm-chain/whisper")
		}
	}
