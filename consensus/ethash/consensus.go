...
var (
	FrontierBlockReward       = big.NewInt(100000000000000) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward      = big.NewInt(100000000000000) // Block reward in wei for successfully mining a block upward from Byzantium
