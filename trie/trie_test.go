...
func (s *spongeDb) NewBatch() database.Batch                 { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) database.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w database.KeyValueWriter) error { return nil }
