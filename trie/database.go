...
func NewDatabaseWithCache(diskdb database.KeyValueStore, cache int, journal string) *Database {
...
func (db *Database) DiskDB() database.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch database.Batch, uncacher *cleaner, callback func(common.Hash)) error {
