...
func newClientPool(db database.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db database.Database, clock mclock.Clock) *nodeDB {
